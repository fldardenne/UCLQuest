...
public class MasterMindController : MonoBehaviour
{
    ...
    {
        num = 3196; //code du pc
        text.text = "Devine le code a 4 chiffres du pc";
        prev.text = "";
        prev2.text = "";
        prev3.text = "";
        prev11.text = "";
        ...
        prev33.text = "";
        prev43.text = "";
        essaiprev.text = "Essai precedent";
        essaiprev2.text = "Essai precedent";
        essaiprev3.text = "Essai precedent";
    }
    public void GetInput(string guess) {
        //Debug.Log("Texte entré : " + guess);
        if (guess.Length < 4)
        {
            text.text = "Le code insere est trop petit, il doit contenir 4 chiffres";
        }
        else {
    ...
    void CompareGuesses(string guess) {
        if (int.TryParse(guess, out value)) {
            ...
            if (guess == "3196") {
                this.panel.transform.Find("item_1").gameObject.SetActive(true);
                text.text = "Bravo tu as recupere le programme !";
                ret.SetActive(true);
                PlayerPrefs.SetInt("mastermind", 1);
            }
        }
        else {
            text.text = "Le code est compose de chiffres pas de lettres !";
        } 
    }
}
